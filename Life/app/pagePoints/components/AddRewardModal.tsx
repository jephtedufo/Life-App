  ...
  const handleSubmit = () => {
    if (title.trim() && cost > 0) {
      ...
      if (editingReward) {
        ...
        addReward(rewardData.title, rewardData.description, rewardData.cost, rewardData.imageUrl);
        // Update the newly created reward with additional properties
        setTimeout(() => {
          // This is a workaround - ideally addReward would accept all properties
        }, 100);
      }
      handleCancel();
    }
                  ...
                  <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden border border-gray-200 relative">
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        // Keep the URL but show error state
                      }}
                    />
                    <button
                      onClick={() => setImageUrl('')}
