...
export const TaskPage: React.FC<TaskPageProps> = ({ onNavigate }) => {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-between items-start mb-16 pt-8">
          <div className="flex-1 pr-8">
            <h1 className="text-6xl font-bold text-gray-900 mb-6">Tasks</h1>
            <p className="text-lg text-gray-600 leading-relaxed italic max-w-4xl">
              Stay organized and productive by managing your daily and upcoming tasks here.
            </p>
          </div>
        </div>
        {/* Navigation Bar and main content wrapper */}
        <div className="space-y-12 mb-8">
          <AppNavigation onNavigate={onNavigate} onAddHabitClick={handleAddTaskClick} showSettingsButton addButtonLabel="Add new task..." />
          <AddTaskModal
          ...
          {/* Edit Task Modal */}
          <AddTaskModal
            isOpen={!!editingTask || showAddTaskModal}
            onClose={() => {
              setEditingTask(null);
